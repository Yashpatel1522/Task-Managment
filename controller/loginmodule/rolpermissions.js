...
const displaySingleRoleHasPermissions = (request, response) => {
  try {
    response.render("loginmodule/totalpermissions");
  } catch (err) {
    logger.log(err);
  }
};
module.exports = { rolePermissionsGet, allPermissionsGet ,displaySingleRoleHasPermissions};
